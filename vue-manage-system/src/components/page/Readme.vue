    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-setting"></i> 简单介绍</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="ms-doc">
            <h3>小鲜驴定制后台管理系统</h3>
            <article>
                ...
                <p>改编自<a href="https://github.com/lin-xin/vue-manage-system">lin-xin/vue-manage-system</a></p>
                <p>适用于绝大部分的后台管理系统（Web Management System）开发。
                    基于vue.js,使用vue-cli脚手架快速生成项目目录，引用Element UI组件库，方便开发快速简洁好看的组件。
                    分离颜色样式，支持手动切换主题色，而且很方便使用自定义主题色。</p>
                <h2>功能</h2>
